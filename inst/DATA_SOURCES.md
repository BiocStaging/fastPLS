...
uses `sample.ExpressionSet`, supplied by the imported Biobase package, and base
R datasets. Their licensing and provenance remain with their source packages.
